                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.course.store') }}" class="mt-4">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="started_at" type="date" format="Y-m-d" class="form-control @error('started_at') is-invalid @enderror" name="started_at" value="{{ old('started_at') }}" required autocomplete="started_at">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="ended_at" type="date" format="Y-m-d" class="form-control @error('ended_at') is-invalid @enderror" name="ended_at" value="{{ old('ended_at') }}" required autocomplete="ended_at">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" required="required" id="teacher_id" name="teacher_id">
                                                ...
                                                <option value="{{ $teacher->id }}">{{ $teacher->select_name }}</option>
                                                @endforeach
                                            </select>
