            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.student.index') }}" >Manage Student</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.student.update', $student->id )}}" class="mt-4">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" required="required" id="status" name="status">
                                                ...
                                                <option value="0"  @if($student->status === 0) selected @endif>Non-active</option>
                                            </select>
                                    ...
                                    <div class="mb-0 form-group row">
                                        <div class="col-md-6 offset-md-4">
                                            <a class="btn btn-outline-primary" href="{{ route('admin.student.index') }}" role="button">Cancel</a>
