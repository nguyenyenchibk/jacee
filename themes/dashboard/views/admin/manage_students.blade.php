                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-info btn-l" href="javascript:;" data-toggle="modal"
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    ?>
                                            ...
                                            <td><input type="checkbox" class="student_status" data-id="{{ $std['id']}}"
                                                    <?php if($std['std_status']==1){ echo "checked" ;} ?> name="status">
                                            </td>
                                            <td>
                                                {{-- <a href="{{url('admin/edit_students/'.$std['id'])}}"
